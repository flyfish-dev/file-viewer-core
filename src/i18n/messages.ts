...
const ZH_CN_MESSAGES: Record<FileViewerMessageKey, string> = {
  ...
  'cad.toolbar.exportImage': '下载 {format} 图片',
  'cad.layers.title': '图层',
  ...
  'cad.error.exportFailed': '图片导出失败：{message}',
  'image.alt': '图片',
...
const EN_US_MESSAGES: Record<FileViewerMessageKey, string> = {
  ...
  'toolbar.searchClose': 'Close search',
  ...
  'cad.toolbar.exportImage': 'Download {format} image',
  ...
  'cad.error.exportFailed': 'Image export failed: {message}',
  'image.alt': 'Image',
